...
<x-nexo-mail::layout title="Something broke" :preheader="$exceptionClass.' — '.$message">
    ...
    <p class="nexo-panel nexo-ink" style="margin:0 0 20px; padding:12px 14px; background-color:#fafafa; border-radius:8px; font-size:14px; line-height:1.6; white-space:pre-line; color:#18181b;">{{ $message }}</p>
